    ...
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900">
      <form onSubmit={handleSubmit} className="bg-white/95 backdrop-blur-sm p-8 rounded-2xl shadow-2xl w-full max-w-sm flex flex-col gap-5 border border-white/10">
        <div className="flex flex-col items-center gap-3 mb-2">
          ...
          <h1 className="text-center text-gray-900 text-xl font-bold">BankSim</h1>
          <p className="text-center text-gray-500 text-sm -mt-1">Acceso Clientes</p>
        </div>
        ...
        <p className="text-center text-sm text-gray-500">
          ¿No tienes cuenta?{' '}
          <Link to="/registro" className="text-blue-600 hover:underline font-medium">Crear cuenta</Link>
        </p>
